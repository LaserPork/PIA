...
<div class="row">	
	...
	<div class="col-md-2"></div> 
	<!-- FORM BEGIN -->
	<form class="col-md-8 post" id="postForm" method="POST"> 
			
	        <div class="form-group post-textarea p-0 mb-0 col-md-12">
	        
			    <label for="post-textarea">What the fuck is happening?</label>
			    <textarea name="postContent" form="postForm" class="form-control" id="post-textarea" rows="3"></textarea>
	  		</div>
	       	<div class="btn-group d-none d-sm-block float-right">
		        <input class="btn post-button mr-0" value="Fuck that!" type="submit">
			</div>	
			
			<div class="d-block d-sm-none col-12 p-0 float-right">
		        <input class="btn post-button col-12" value="Fuck that!" type="submit">
			</div>	
		   ...
		   <!--   <li class="page-item disabled">
		    ...
		    <c:choose>
		    	<c:when test="${pageValue eq requestScope.page}">
		    	 <li class="page-item"><a class="btn logout-button" href="<c:url value ="/home?page=${pageValue}"/>">${pageValue}</a></li>
		    	</c:when>
		    	<c:otherwise>
		    	 <li class="page-item"><a class="btn post-button" href="<c:url value ="/home?page=${pageValue}"/>">${pageValue}</a></li>	
		    	</c:otherwise>
		    </c:choose>
			</c:forEach>
